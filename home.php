...
<section class="bg-[#F7F3ED] px-4 py-24">
  <div class="mx-auto grid max-w-6xl grid-cols-1 gap-10 lg:grid-cols-[1fr_300px]">

    <div>

      <div class="mb-16 text-center">
        <p class="text-xs font-medium uppercase tracking-[0.3em] text-[#C8A98A]">Fresh From the Cafe</p>
        <h1 class="mt-4 font-serif text-4xl font-medium text-[#2B2118] md:text-5xl">Blogs</h1>
      </div>
      ...
      <?php endwhile; else : ?>
        ...
        <p class="text-[#6F5540]">No posts yet.</p>
